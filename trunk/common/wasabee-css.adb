package body Wasabee.Css is
   ...
   begin
      ...
      loop
         ...
         Add_Or_Replace_CSS(Map , TKey, To_String(Key) , To_String(Value)) ;
         Base := Sep_Pos + 1 ;
      end loop ;
   end ;
   ...
   begin
      loop
         ...
         Parse_Css_Element (Map , To_String(Key), Css_Content);
         New_Line ;
         Base := Closebracket+1 ;
      end loop;
   end;

   procedure Get_Css_Unit_Element (Map : in out CSS_Dictionary.Map ;
                                   TKey : String ;
                                   Content : String ;
                                   Css : Unbounded_String) is
      Base : Natural := 1;
   ...
   begin
      ...
      Parse_Css_Element (map, TKey, key);
      New_Line ;
   end ;
   ...
   procedure Add_Or_Replace_CSS (Map : in out CSS_Dictionary.Map ;
                                 Element : String ;
                                 Key : String ;
                                 Value : String) is
      Ptr : CSS_Properties_Map_Ptr ;
      Cleaned_Key : Unbounded_String ;
   begin

      Cleaned_Key := Clean_Key(To_Unbounded_String(Key)) ;
   ...
   function  Get_CSS (Map : CSS_Dictionary.Map ;
                      Element : String ;
